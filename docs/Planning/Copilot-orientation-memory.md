...
| ---------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `SectionFrame` (layout)                  | `<section>`, container, heading block (kicker, h2, description), tone/background, section padding, split layout | Props: `tone` (mist/white/dark/gradient-dark/gradient-mist/gradient-teal), `layout` (stack/split), `ratio` (50-50/40-60/60-40), `contentClassName`; page CSS must NOT override `mw-section-frame__header/heading/description/eyebrow`; no `headerWidth` or `gap` props |
