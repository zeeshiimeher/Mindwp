...
Authority for public-facing language, voice, rewrite behavior, banned phrasing, and copy validation.
...
- Do not invent proof, numbers, rankings, testimonials, guarantees, or client results.
