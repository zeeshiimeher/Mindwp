...
const VALIDATOR_DEFINITIONS = [
  ...
  {
    name: 'validate-render-alignment',
    category: 'content',
    command: 'npx',
    args: ['tsx', 'scripts/validators/validate-render-alignment.ts', '--report-json'],
    blocking: true,
  ...
  },
  {
    ...
    blocking: true,
    reportFile: 'no-hardcoded-content-report.json',
  },
  {
    name: 'validate-variant-required-data',
    category: 'content',
    command: 'node',
    args: [
      '--import',
    ...
    blocking: true,
    reportFile: 'variant-required-data-report.json',
  },
  {
  ...
  {
    name: 'validate-primary-cta',
    category: 'cta',
    command: 'node',
    args: ['--import', 'tsx/esm', 'scripts/validators/validate-primary-cta.ts', '--report-json'],
    blocking: true,
    reportFile: 'cta-contract-report.json',
  },
  {
  ...
  {
    name: 'validate-system-topic-integrity',
    category: 'core',
    command: 'npx',
    args: ['tsx', 'scripts/validators/validate-system-topic-integrity.mjs', '--report-json'],
    blocking: true,
...
const QUICK_VALIDATOR_NAMES = [
  ...
  'validate-system-topic-integrity',
...
const PRIMARY_REPORT_FILES = [
  ...
  'no-hardcoded-content-report.json',
  ...
  'system-topic-integrity-report.json',
  'system-report.json',
  ...
  'variant-required-data-report.json',
...
const GENERATED_MARKDOWN_FILES = ['reports/client-report.md', 'reports/topic-authority-scores.md'];

const GENERATED_CODE_FILES = ['src/lib/authority/generated/authorityMap.ts'];
