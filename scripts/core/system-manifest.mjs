...
const VALIDATOR_DEFINITIONS = [
  ...
  {
    name: 'validate-no-brand-in-content',
    category: 'content',
    command: 'node',
    args: [
      '--import',
    ...
    blocking: true,
    reportFile: 'no-brand-in-content-report.json',
  },
  {
    name: 'validate-no-manual-canonical',
    category: 'seo',
    command: 'node',
    args: [
      '--import',
    ...
    blocking: true,
    reportFile: 'no-manual-canonical-report.json',
  },
  {
    name: 'validate-missing-seo-title',
    category: 'seo',
    command: 'node',
    args: [
      '--import',
    ...
    blocking: true,
    reportFile: 'missing-seo-title-report.json',
  },
  {
    name: 'validate-og-image-required',
    category: 'seo',
    command: 'node',
    args: [
      '--import',
      'tsx/esm',
      'scripts/validators/validate-og-image-rules.ts',
      '--rule=og-image-required',
      '--report-json',
    ],
    blocking: true,
    reportFile: 'og-image-required-report.json',
  },
  {
    name: 'validate-no-manual-og-image',
    category: 'seo',
    command: 'node',
    args: [
      '--import',
    ...
    blocking: true,
    reportFile: 'no-manual-og-image-report.json',
  },
  {
    name: 'validate-og-input-valid',
    category: 'seo',
    command: 'node',
    args: [
      '--import',
    ...
    blocking: true,
    reportFile: 'og-input-valid-report.json',
  },
  {
    name: 'validate-og-fallback-integrity',
    category: 'seo',
    command: 'node',
    args: [
      '--import',
    ...
    blocking: true,
    reportFile: 'og-fallback-integrity-report.json',
  },
  {
  ...
  },
  {
    ...
    category: 'core',
    command: 'node',
    args: ['--import', 'tsx/esm', 'scripts/validators/validate-generated-artifact-integrity.ts'],
    blocking: true,
    reportFile: 'generated-artifact-integrity-report.json',
  },
  {
...
const QUICK_VALIDATOR_NAMES = [
  ...
  'validate-generated-file-protection',
];
...
const PRIMARY_REPORT_FILES = [
  ...
  'generated-artifact-integrity-report.json',
  ...
  'no-manual-og-image-report.json',
  'no-manual-canonical-report.json',
  'og-image-required-report.json',
  'page-priorities.json',
  'og-fallback-integrity-report.json',
  'og-input-valid-report.json',
