...
// Generated by: tsx scripts/generators/generate-authority-map.ts
// Source: structured content graph, route inventory
...
export async function buildAuthorityMapArtifacts() {
  ...
  const content = [
    buildGeneratedCodeNotice({
      generatedBy: 'tsx scripts/generators/generate-authority-map.ts',
      source: 'structured content graph, route inventory',
