...
async function main() {
    ...
    if (simulatedNewRoute.index) {
        failures.push({
            ...
            message: 'Simulated new route /tools/test-page is indexable. Fallback must default to noindex.',
        });
    }
    ...
    if (simulatedNewTopicRoute.index) {
        failures.push({
            ...
            message: 'Simulated new topic route /topics/test-page is indexable. Topic fallback must default to noindex.',
        });
    }
