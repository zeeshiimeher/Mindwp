...
export function LogoMark({ className = '' }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* Connection dots */}
      <circle cx='11' cy='10' r='1.5' fill='var(--mw-brand-primary)' />
      <circle cx='21' cy='10' r='1.5' fill='var(--mw-brand-secondary)' />
      <circle cx='11' cy='16' r='1.5' fill='var(--mw-brand-secondary)' />
      <circle cx='21' cy='16' r='1.5' fill='var(--mw-brand-primary)' />
      <circle cx='11' cy='22' r='1.5' fill='var(--mw-brand-primary)' />
      <circle cx='21' cy='22' r='1.5' fill='var(--mw-brand-secondary)' />
