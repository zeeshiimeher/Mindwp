      ...
      items: [
        {
          ...
          description: 'Visual accuracy, drag-and-drop editing, strong ecosystem. The tool does its job.',
        },
        {
          title: 'But visitors still leave without acting',
          description: 'Services are lumped together. The next step isn\'t obvious. Someone looking for one thing can\'t find it quickly enough.',
        },
        {
          title: 'Enquiries get lost between arrival and response',
          description: 'A form goes to a generic inbox. Nobody sees it until end of day. The visitor has already rung someone else.',
        },
        {
          title: 'No follow-up after first contact',
          description: 'Someone fills in a form and hears nothing for two days. No confirmation, no reminder, no next step.',
        },
      ],
      columns: 4 as const,
    ...
    processSection: {
      ...
      steps: [
        ...
        },
        {
          ...
          description: 'Which services need their own presence, how people get in touch, and what happens after they do.',
          icon: Layers,
        },
        {
          number: '3',
          title: 'Build with the right approach',
          description: 'If Elementor fits, we use it. Clean layouts, governed editing, responsive work that holds up.',
          icon: Layout,
        },
        {
          number: '4',
        ...
        },
        {
          ...
          description: 'Not just visual checks. We make sure someone can find what they need, reach out, and get handled properly.',
          icon: Code,
        },
        {
          number: '6',
