        ...
        <main role='main'>
                    ...
                    <div className='sws-leak-map__primary'>
                      ...
                      <div className='sws-leak-map__primary-zones'>
                        ...
                        <div className='sws-leak-map__primary-zone sws-leak-map__primary-zone--handled'>
                          ...
                          <p className='sws-leak-map__zone-text'>
                            {leakMap.primaryLeak.handledState}
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className='rd-container'>
                    ...
                    <div className='sws-comparison__panels'>
                      <div className='sws-comparison__panel sws-comparison__panel--left'>
                        ...
                        <h3 className='sws-comparison__state-title'>
                          {comparison.leftState.title}
                        </h3>
                        <dl className='sws-comparison__groups'>
                          {(comparison.leftState.groups as { label: string; text: string }[]).map(
                            g => (
                      ...
                      <ul className='sws-handoff__connections'>
                        {(
                          ...
                          <li key={conn.targetSystem} className='sws-handoff__module'>
                            <p className='sws-handoff__module-label'>
                              {HANDOFF_CONNECTED_LABEL_DOT}
                            </p>
          ...
          {coverageLedger &&
            (() => {
              ...
              return (
                <section
                  className='rd-section sws-coverage-ledger'
                  aria-label={ARIA_COVERAGE_LEDGER_DOT}
                >
                  <div className='rd-container'>
                    <header className='rd-section-head'>
                    ...
                    <div className='sws-coverage-ledger__layout'>
                      {Array.isArray(coverageLedger.legend) && coverageLedger.legend.length > 0 && (
                        <aside
                          className='sws-coverage-ledger__legend'
                          aria-label={ARIA_COVERAGE_LEGEND_DOT}
                        >
                          <ul className='sws-coverage-ledger__legend-list'>
                            {(coverageLedger.legend as string[]).map(item => (
                              <li key={item} className='sws-coverage-ledger__legend-item'>
                                {item}
                              </li>
                            ))}
                          </ul>
                        ...
                        {(
                          ...
                          <div key={band.name} className='sws-coverage-ledger__band'>
                            ...
                            <ul className='sws-coverage-ledger__band-items'>
                              <li
                                className='sws-coverage-ledger__band-item-label'
                                aria-hidden='true'
                              >
                    ...
                    {coverageLedger.closingStatement && (
                      <p className='sws-coverage-ledger__closing'>
                        {coverageLedger.closingStatement}
                      </p>
                    )}
                  </div>
          ...
          {environmentRoster &&
            (() => {
              ...
              return (
                <section
                  className='rd-section sws-environment-roster'
                  aria-label={ARIA_ENVIRONMENT_ROSTER_DOT}
                >
                  <div className='rd-container'>
                    <header className='rd-section-head'>
                    ...
                    <div
                      className='sws-environment-roster__table'
                      role='table'
                      aria-label={ARIA_ENVIRONMENT_TABLE_DOT}
                    >
                      <div className='sws-environment-roster__header' role='row'>
                        <span className='sws-environment-roster__col-head' role='columnheader'>
                          {ROSTER_COL_ENV_DOT}
                        </span>
                        <span className='sws-environment-roster__col-head' role='columnheader'>
                          {ROSTER_COL_TRIGGERS_DOT}
                        </span>
                        <span className='sws-environment-roster__col-head' role='columnheader'>
                          {ROSTER_COL_NEED_DOT}
                        </span>
                        <span className='sws-environment-roster__col-head' role='columnheader'>
                          {ROSTER_COL_SIGNALS_DOT}
                        </span>
                      </div>
                      {(
                      ...
                      <aside className='sws-proof-story__context'>
                        ...
                        {proofStory.context?.constraint && (
                          <div className='sws-proof-story__context-constraint'>
                            <p className='sws-proof-story__constraint-label'>
                              {PROOF_CONSTRAINT_LABEL_DOT}
                            </p>
                        ...
                        {proofStory.proofType && (
                          <div className='sws-proof-story__proof-type'>
                            <p className='sws-proof-story__proof-type-label'>
                              {PROOF_TYPE_PREFIX_DOT}
                            </p>
                            <p className='sws-proof-story__proof-type-value'>
                              {proofStory.proofType}
                            </p>
                          </div>
                        )}
                      ...
                      {compoundingSignals.liveSignal && (
                        <div className='sws-compounding__live'>
                          <div className='sws-compounding__receipt'>
                            <p className='sws-compounding__receipt-title'>
                              {compoundingSignals.liveSignal.title}
                            </p>
                            <ul className='sws-compounding__receipt-rows'>
                              {(
                                compoundingSignals.liveSignal.rows as {
                                  label: string;
                                  value: string;
                                  status: string;
                                }[]
                                ...
                                <li key={row.label} className='sws-compounding__receipt-row'>
                                  <span
                                    className={`rd-dot rd-dot--${row.status}`}
                                    aria-hidden='true'
                                  />
                                  <span className='sws-compounding__receipt-label'>
                                    {row.label}
                                  </span>
                                  <span className='sws-compounding__receipt-value'>
                                    {row.value}
                                  </span>
                                </li>
                              ))}
                      ...
                      <ul className='sws-compounding__effects'>
                        {(
                          ...
                          <li key={effect.title} className='sws-compounding__effect'>
                            <span className='sws-compounding__effect-index' aria-hidden='true'>
                              {String(index + 1).padStart(2, '0')}
                            </span>
                            <div className='sws-compounding__effect-body'>
                              ...
                              <div className='sws-compounding__effect-states'>
                                <div className='sws-compounding__effect-state sws-compounding__effect-state--before'>
                                  <span className='sws-compounding__state-label'>
                                    {COMPOUNDING_BEFORE_LABEL_DOT}
                                  </span>
                  ...
                  <div className='rd-container'>
                    ...
                    <div className='sws-fit-filter__panels'>
                      <div className='sws-fit-filter__panel sws-fit-filter__panel--strong'>
                        ...
                        <h3 className='sws-fit-filter__panel-title'>
                          {fitFilter.strongFit?.title}
                        </h3>
                      ...
                      <div className='sws-fit-filter__panel sws-fit-filter__panel--not'>
                        ...
                        <ul className='sws-fit-filter__scenarios'>
                          {(
                            fitFilter.notFit?.scenarios as { title: string; description: string }[]
                          )?.map(s => (
                            <li key={s.title} className='sws-fit-filter__scenario'>
                              <h4 className='sws-fit-filter__scenario-title'>{s.title}</h4>
                              <p className='sws-fit-filter__scenario-desc'>{s.description}</p>
