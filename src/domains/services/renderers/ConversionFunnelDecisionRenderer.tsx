...
const ARIA_HERO_DOT = 'Funnel Decision -- page hero';
...
export function ConversionFunnelDecisionRenderer({ data, slug: _slug }: Props) {
  ...
  if (!primarySystem) throw new Error('[funnel-decision] Missing service system');
  const contactHref = buildServiceContactHref({ system: primarySystem, slug: data.slug });

  return (
    <div className='funnel-decision-page decision-page'>
      <HeroFrame
        className='funnel-decision-hero decision-hero'
      ...
      <DecisionPanel
        className='funnel-decision-cta decision-cta'
        heading={cta.heading}
