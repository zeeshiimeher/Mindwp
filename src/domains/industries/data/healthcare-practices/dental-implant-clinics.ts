...
export const DentalImplantClinicsIndustryPageData: IndustryDetailPageData = {
  seo: {
    title: 'Dental Implant Clinics Website Systems',
    description: 'Dental implant clinic website systems reset base.',
    canonical: '/industries/healthcare-practices/dental-implant-clinics',
    openGraph: {
      title: 'Dental Implant Clinics Website Systems',
      description: 'Dental implant clinic website systems reset base.',
    },
  ...
  hero: {
    eyebrow: 'Dental Implant Clinics',
    title: 'Dental Implant Clinics Page Is on a Clean Rebuild Base.',
  },
  ...
  decisionPanel: {
    heading: {
      eyebrow: 'Next step',
      title: 'Review the dental implant clinics website and handling path.',
      description:
    ...
    actions: [
      {
        ...
        href: '/contact?system=smart-website-systems&source=industry%2Fdental-implant-clinics',
        variant: 'primary',
      },
    ],
    expectations: [
