...
export const PhysiotherapyClinicsIndustryPageData: IndustryDetailPageData = {
  seo: {
    title: 'Physiotherapy Clinics Website Systems',
    description: 'Physiotherapy clinic website systems reset base.',
    canonical: '/industries/healthcare-practices/physiotherapy-clinics',
    openGraph: {
      title: 'Physiotherapy Clinics Website Systems',
      description: 'Physiotherapy clinic website systems reset base.',
    },
  ...
  hero: {
    eyebrow: 'Physiotherapy Clinics',
    title: 'Physiotherapy Clinics Page Is on a Clean Rebuild Base.',
  },
  ...
  decisionPanel: {
    heading: {
      eyebrow: 'Next step',
      title: 'Review the physiotherapy clinics website and handling path.',
      description:
    ...
    actions: [
      {
        ...
        href: '/contact?system=smart-website-systems&source=industry%2Fphysiotherapy-clinics',
        variant: 'primary',
      },
    ],
    expectations: [
