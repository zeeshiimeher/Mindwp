...
export const OrthodonticClinicsIndustryPageData: IndustryDetailPageData = {
  seo: {
    title: 'Orthodontic Clinics Website Systems',
    description: 'Orthodontic clinic website systems reset base.',
    canonical: '/industries/healthcare-practices/orthodontic-clinics',
    openGraph: {
      title: 'Orthodontic Clinics Website Systems',
      description: 'Orthodontic clinic website systems reset base.',
    },
  ...
  hero: {
    eyebrow: 'Orthodontic Clinics',
    title: 'Orthodontic Clinics Page Is on a Clean Rebuild Base.',
  },
  ...
  decisionPanel: {
    heading: {
      eyebrow: 'Next step',
      title: 'Review the orthodontic clinics website and handling path.',
      description:
    ...
    actions: [
      {
        ...
        href: '/contact?system=smart-website-systems&source=industry%2Forthodontic-clinics',
        variant: 'primary',
      },
    ],
    expectations: [
