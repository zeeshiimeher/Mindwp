...
export const RoofingCompaniesIndustryPageData: IndustryDetailPageData = {
  ...
  hero: {
    ...
    title: 'Roofing Companies Page Is on a Clean Rebuild Base.',
  },
  industries: ['roofing'],
  ...
  decisionPanel: {
    heading: {
      eyebrow: 'Next step',
      title: 'Review the roofing companies website and handling path.',
      description:
    ...
    actions: [
      {
        ...
        href: '/contact?system=smart-website-systems&source=industry%2Froofing-companies',
        variant: 'primary',
      },
    ],
    expectations: [
