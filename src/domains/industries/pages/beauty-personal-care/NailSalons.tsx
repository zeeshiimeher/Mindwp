...
export const nailSalonsIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Nail Salons Systems',
      description: 'Enquiry handling, follow-up, and trust structure for nail salons.',
    },
  },
  slug: 'nail-salons',
  type: 'detail',
  ...
  hero: {
    badge: 'Nail Salons',
    title: 'Nail Salons [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Nail Salons leak pattern',
      description:
        'Show the exact points where nail salons lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about nail salons systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where nail salons enquiries slip',
      description:
