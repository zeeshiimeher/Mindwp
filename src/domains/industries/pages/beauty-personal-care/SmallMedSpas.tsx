...
export const smallMedSpasIndustryPageData: IndustryDetailPageData = {
  seo: {
    title: 'Small Med Spas Systems',
    description:
      'Holding structure for small med spas: enquiry capture, fast response, follow-up ownership, and local trust.',
    canonical: '/industries/beauty-personal-care/small-med-spas',
    openGraph: {
      title: 'Small Med Spas Systems',
      description: 'Enquiry handling, follow-up, and trust structure for small med spas.',
    },
  },
  slug: 'small-med-spas',
  type: 'detail',
  ...
  hero: {
    badge: 'Small Med Spas',
    title: 'Small Med Spas [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Small Med Spas leak pattern',
      description:
        'Show the exact points where small med spas lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about small med spas systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where small med spas enquiries slip',
      description:
