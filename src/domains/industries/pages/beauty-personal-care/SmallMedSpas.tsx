...
function buildSmallMedSpasIndustryPageData(): IndustryPageData {
  const heroData = {
    badge: 'Med Spas',
    title:
      'She Filled In The Consultation Form On Tuesday Night. By Friday She Had Booked The Clinic That Replied On Wednesday.',
    description:
  ...
  const decisionChecklistData = {
    ...
    description:
      'She is not only comparing prices or treatment menus. She is checking whether the clinic feels safe, organised, and steady enough to trust with something she is still slightly nervous about.',
    items: [
    ...
    benefits: [
      {
        ...
        description:
          'By the time anyone replied, she had already taken a Friday consult somewhere that felt more responsive. The enquiry itself was fine. What failed was the speed and tone of the first reply.',
      ...
      },
      {
        ...
        description:
          'No written plan arrived and no calm follow-up came in the window where she was still thinking hard about it. She liked the practitioner, but the silence made the whole decision easier to postpone.',
      ...
      },
      {
        ...
        description:
          'Series-based treatments need steady rebook timing or the plan starts slipping after the early momentum. Without that structure, a four-session plan can quietly turn into one or two visits and then stop.',
  ...
  const systemLayersData = {
    ...
    description:
      'You stay focused on assessment and treatment. The part that turns an enquiry into a booked consult and a consult into a completed plan stops depending on someone remembering to chase it later.',
    featureCategories: [
      {
        title: 'Same-day, named reply to every enquiry',
        description:
          'No web form sits untouched into the next day. The first reply offers two consult times and sounds like a real person in the clinic, not an empty portal message.',
        icon: PhoneCall,
        features: [
      ...
      },
      {
        ...
        description:
          'A short structured intake arrives before the consult, then a written plan follows after it. She can see the clinic has taken her goals seriously instead of leaving her to remember everything herself.',
        icon: ClipboardList,
        features: [
      ...
      },
      {
        ...
        description:
          'Series-based treatments get rebook prompts at the right interval, before the plan loses momentum. That keeps a treatment journey moving instead of leaving it to stall after session one or two.',
        icon: CalendarCheck,
        features: [
      ...
      },
      {
        ...
        description:
          'Review requests go out when results are visible and the client feels settled in the choice she made. That is very different from asking after session one when she may still be unsure and watching closely.',
        icon: Star,
        features: [
      ...
      },
      {
        ...
        description:
          'Your Google profile and treatment pages line up around the actual treatments, real reviews, and practitioner credentials. The tone stays calm and confident, which matters more here than sounding loud or salesy.',
        icon: Search,
        features: [
  ...
  const exploreData = {
    badge: 'Related',
    description:
      'These are the supporting services that come up most often once a med spa sees where enquiries and plans are quietly dropping. They all support the same trust, reply, and completion gaps from different sides.',
    cards: [
      {
        icon: PhoneCall,
        title: 'Smart Website Systems',
        description:
          'Keeps same-day replies, consult booking, and written next steps moving without leaving the clinic to carry the whole load in the inbox.',
      ...
      },
      {
        ...
        description:
          'Keeps series rebooks, follow-ups, and plan completion moving so a treatment journey does not quietly stall after the first signs of hesitation.',
      ...
      },
      {
        ...
        description:
          'Collects reviews from completed plans so the proof seen by comparison-minded clients matches the quality of the journeys you are already delivering.',
      ...
      },
      {
        ...
        description:
          'Helps the clinic show up for the treatments it actually offers and read as safe, credible, and organised from the first search impression.',
  ...
  const faqData = {
    ...
    description:
      'These are the practical questions that usually come up in a clinic-led business where the decision is slower, more cautious, and easier to lose in the follow-up. Straight answers, no sales gloss.',
    faqs: [
      {
