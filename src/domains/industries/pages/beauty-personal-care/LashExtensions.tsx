...
function buildLashExtensionsIndustryPageData(): IndustryPageData {
  const heroData = {
    badge: 'Lash Studios',
    title:
      'Her Refill Was Due Three Weeks Ago. She Did Not Switch — She Just Got Tired Of Remembering.',
    description:
    ...
    benefits: [
      {
        ...
        description:
          "No nudge went out when her usual refill window opened. By week four her lashes were patchy, and by week five she had searched for a refill nearby and sat in somebody else's chair instead.",
      ...
      },
      {
        ...
        description:
          'The full set went well, but nothing arrived after it to guide her into the refill rhythm. No follow-up and no warm "ready when you are" means the second appointment never gets anchored.',
      ...
      },
      {
        ...
        description:
          'She was not trying to make a dramatic change. She just needed a refill that fit this week, missed her normal window, and took the first decent slot that appeared before yours did.',
  ...
  const workflowExamplesData = {
    ...
    description:
      'These are not broad campaigns or discount pushes. They are the small messages that hold the cycle together between a fresh set, the first refill, and the point where drift usually starts.',
    workflows: [
      {
  ...
  const systemLayersData = {
    ...
    description:
      'You stay focused on the lash line and the appointment in front of you. The cycle that decides whether she comes back stops depending on her memory, your memory, or a note buried in old messages.',
    featureCategories: [
      {
        title: 'Refill nudges that match her cycle',
        description:
          'Two-week, three-week, four-week — the prompt lands in the right window for her actual cycle, not as part of a generic blast. That keeps the refill feeling timely instead of overdue.',
        icon: Bell,
        features: [
      ...
      },
      {
        ...
        description:
          'A single warm message sent at the right time does more than repeated discount pushes. It feels like a tech noticing the gap, not a studio throwing money at somebody already halfway out.',
        icon: HeartHandshake,
        features: [
      ...
      },
      {
        ...
        description:
          'New enquiries see real availability in the first reply, with the difference between refill and full set already accounted for. That stops a fragile new enquiry from stalling before the first booking happens.',
        icon: Calendar,
        features: [
      ...
      },
      {
        ...
        description:
          'A review request goes out while the set still looks fresh and she is still looking at it in every mirror. That is the moment most likely to turn a good appointment into visible proof.',
        icon: Star,
        features: [
      ...
      },
      {
        ...
        description:
          'Search intent for "lash refill near me" is usually stronger than a broad lashes search because it comes from someone already in cycle. We line the studio up for that higher-fit search instead of hoping generic visibility is enough.',
        icon: Search,
        features: [
  ...
  const exploreData = {
    badge: 'Related',
    description:
      'These are the supporting services that come up most often once a lash studio sees how much hinges on cycle timing and rebook handling. They all support retention, trust, and refill visibility from different sides.',
    cards: [
      {
        icon: Bell,
        title: 'CRM & Rebook Automation',
        description:
          'Keeps refill prompts matched to her actual cycle instead of dropping everyone into the same generic calendar reminder.',
      ...
      },
      {
        ...
        description:
          'Shows live refill and full-set slots in the first reply, so new enquiries do not cool off before the first appointment is even booked.',
      ...
      },
      {
        ...
        description:
          'Gets reviews out while the set still feels fresh, so the online proof reflects the reactions clients actually have after the appointment.',
      ...
      },
      {
        ...
        description:
          'Helps the studio show up when someone searches specifically for a refill nearby, which is usually the highest-intent search in the whole cycle.',
  ...
  const faqData = {
    ...
    description:
      'These are the practical questions that usually come up in a refill-led studio where loyalty looks strong until one missed cycle proves otherwise. Straight answers, written around that reality.',
    faqs: [
      {
