...
function buildAestheticCosmeticClinicsIndustryPageData(): IndustryPageData {
        ...
        benefits: [
            {
                ...
                description: 'She remembered the room and how the consult felt, but not the numbers, recovery timing, or which option you actually leaned toward. By day three the detail had blurred and doubt had filled the gaps.',
                iconType: 'primary' as const,
            },
            {
                icon: HeartHandshake,
                title: 'No structured follow-up at day three or day seven',
                description: 'Not a discount and not a hard close. Just a calm, real "we are here when you are ready" with the plan attached. Without that, she can read the silence as distance, busyness, or uncertainty.',
                iconType: 'secondary' as const,
            },
            {
                icon: Eye,
                title: 'She compared three clinics — and yours read quietest',
                description: 'The credentials may have been similar across all three clinics, but one looked more current, more trusted, and more present. Sparse reviews and a thin profile make hesitation heavier, especially when the treatment carries fear with it.',
    ...
    const workflowExamplesData = {
        ...
        description: 'This is not a campaign and it does not need to sound like one. It is a small set of calm touches that hold trust steady between the consult, the questions at home, and the final decision.',
        workflows: [
            {
    ...
    const systemLayersData = {
        ...
        description: 'You stay focused on the consult, the work, and the outcome. The part that keeps trust alive between the consult and the booking stops depending on someone remembering to send the right email a few days later.',
        featureCategories: [
            {
                title: 'Written consult summaries — every time',
                description: 'Within 24 hours, in her words, with the options she actually discussed. Recovery, timing, and what to think about are laid out clearly, while pricing is handled with care instead of being pushed to the top.',
                icon: FileText,
                features: [
            ...
            },
            {
                ...
                description: 'Two calm, named follow-ups land in the exact window where second thoughts usually appear. They stop the moment she replies or books, so the contact feels present rather than pressing.',
                icon: CalendarRange,
                features: [
            ...
            },
            {
                ...
                description: 'Recent reviews, real outcomes, and credentials are visible where comparison happens, not hidden behind extra clicks. That matters when someone is actively looking for reasons to feel reassured before saying yes.',
                icon: ShieldCheck,
                features: [
            ...
            },
            {
                ...
                description: 'Google profile, pages, and proof all line up with the treatments you actually perform instead of sounding like a generic clinic template. That makes the whole clinic feel more current and more trustworthy before contact even starts.',
                icon: Search,
                features: [
            ...
            },
            {
                ...
                description: 'Review prompts go out when outcomes are visible and the client feels settled in what she chose. That produces reviews that read like real treatment journeys rather than shallow first impressions.',
                icon: Star,
                features: [
    ...
    const exploreData = {
        badge: 'Related',
        description: 'These are the supporting services that come up most often once a clinic sees how much of the decision happens after the consult. They all support trust, follow-up, and comparison moments from different angles.',
        cards: [
            {
                icon: FileText,
                title: 'Smart Website Systems',
                description: 'Keeps consult summaries, calm follow-ups, and trust signals moving in the channel she actually reads when she goes home to think it through.',
            ...
            },
            {
                ...
                description: 'Handles day-three and day-seven nurture in a way that feels steady and personal instead of sounding like a sales sequence.',
            ...
            },
            {
                ...
                description: 'Collects reviews from real outcomes in the places where high-consideration comparison decisions are usually being made.',
            ...
            },
            {
                ...
                description: 'Helps the clinic show up and read as calm, current, and credible for the considered searches most likely to turn into the right kind of enquiry.',
    ...
    const faqData = {
        ...
        description: 'These are the practical questions that usually come up in a high-ticket clinic where trust, fear, and hesitation all sit in the follow-up window after the consult. Straight answers, kept calm.',
        faqs: [
            {
