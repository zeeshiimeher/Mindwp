...
export const aestheticCosmeticClinicsIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Aesthetic and Cosmetic Clinics Systems',
      description:
        'Enquiry handling, follow-up, and trust structure for aesthetic and cosmetic clinics.',
    },
  },
  ...
  hero: {
    ...
    title: 'Aesthetic and Cosmetic Clinics [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Aesthetic and Cosmetic Clinics leak pattern',
      description:
        'Show the exact points where aesthetic and cosmetic clinics lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about aesthetic and cosmetic clinics systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where aesthetic and cosmetic clinics enquiries slip',
      description:
