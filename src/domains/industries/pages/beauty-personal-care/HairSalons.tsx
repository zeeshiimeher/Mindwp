...
function buildHairSalonsIndustryPageData(): IndustryPageData {
        ...
        benefits: [
            {
                ...
                description: 'You were halfway through a colour with a client in the chair and gloves on. By the time you put the bowl down and checked the phone, that Saturday cut had already gone to a salon that answered while you were still working.',
                iconType: 'primary' as const,
            },
            {
                icon: Clock4,
                title: '"What slots do you have Saturday?" took an hour to answer',
                description: 'An hour is long enough for someone checking availability on a lunch break to move on. She scrolled, saw another salon had a real time ready, and stopped waiting for you to come back with options.',
                iconType: 'secondary' as const,
            },
            {
                icon: RotateCcw,
                title: 'A regular has not been in for four months',
                description: 'She used to come every six or eight weeks, then one missed visit turned into three or four months. Nobody nudged her when the gap first opened, so now the habit is broken and the return gets harder.',
    ...
    const workflowExamplesData = {
        ...
        description: 'These are the small chair-side handoffs that usually decide who books and who drifts. None of them feel dramatic in the moment, but they change how full the diary looks a few weeks later.',
        workflows: [
            {
    ...
    const systemLayersData = {
        ...
        description: 'You stay behind the chair and keep the salon moving. The part that decides who fills it next stops depending on you finding five spare minutes between colour, rinse, and checkout.',
        featureCategories: [
            {
                title: 'Reply with availability, not "let me check"',
                description: 'New enquiries see real slots within minutes instead of waiting on a manual reply. That matters most on busy days when every chair is already full and the phone will not stop going.',
                icon: Calendar,
                features: [
            ...
            },
            {
                ...
                description: 'Six-week, eight-week, twelve-week — each service gets nudged at the point the client would normally be thinking about coming back. That catches the gap before a few missed weeks turn into months.',
                icon: Bell,
                features: [
            ...
            },
            {
                ...
                description: 'Reminders go out the day before, then a simple confirm tap lands on the morning of the appointment. Empty chairs stop arriving as a surprise halfway through the day.',
                icon: Sparkles,
                features: [
                    'Day-before reminder',
            ...
            },
            {
                ...
                description: 'A review request goes out the same evening, while the cut, colour, or blow-dry still feels fresh. That is when clients are most likely to leave something that matches the experience they just had.',
                icon: ShieldCheck,
                features: [
            ...
            },
            {
                ...
                description: 'Your pages and Google profile line up around area, service, and stylist instead of generic salon language. That helps the right local searches land on something that feels specific enough to book from.',
                icon: Search,
                features: [
    ...
    const exploreData = {
        badge: 'Related',
        description: 'These are the supporting services that come up most often once the salon sees where bookings and rebooks are thinning out. They all reinforce the same chair-side weak spots from a different direction.',
        cards: [
            {
                icon: Calendar,
                title: 'Smart Website Systems',
                description: 'Shows real slots in the first reply, even while somebody is still in the chair and you cannot stop to type a full answer.',
            ...
            },
            {
                ...
                description: 'Brings regulars back before the gap stretches too far and the old six-week pattern turns into a four-month silence.',
            ...
            },
            {
                ...
                description: 'Gets reviews out often enough that the online proof starts to reflect how full the salon actually feels in a real week.',
            ...
            },
            {
                ...
                description: 'Helps the salon show up for the actual service and area search, not just as one more generic listing in the same part of town.',
    ...
    const faqData = {
        ...
        description: 'These are the practical questions that usually come up when the salon is busy, the phone keeps going, and the rebook gap is already starting to show. Straight answers, written for a chair-led day.',
        faqs: [
            {
