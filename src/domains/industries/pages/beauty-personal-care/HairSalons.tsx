...
export const hairSalonsIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Hair Salons Systems',
      description: 'Enquiry handling, follow-up, and trust structure for hair salons.',
    },
  },
  slug: 'hair-salons',
  type: 'detail',
  ...
  hero: {
    badge: 'Hair Salons',
    title: 'Hair Salons [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Hair Salons leak pattern',
      description:
        'Show the exact points where hair salons lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about hair salons systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where hair salons enquiries slip',
      description:
