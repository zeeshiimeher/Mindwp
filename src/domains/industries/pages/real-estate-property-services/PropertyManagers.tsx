...
export const propertyManagersIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Property Managers Systems',
      description: 'Enquiry handling, follow-up, and trust structure for property managers.',
    },
  },
  ...
  hero: {
    ...
    title: 'Property Managers [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Property Managers leak pattern',
      description:
        'Show the exact points where property managers lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about property managers systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where property managers enquiries slip',
      description:
