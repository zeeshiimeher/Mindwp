...
function buildRealtorsIndustryPageData(): IndustryPageData {
  const heroData = {
    badge: 'Realtors',
    title:
      'You Were Mid-Viewing. Their Phone Rang Three Times. The Next Agent Picked Up On The First.',
    description:
    ...
    benefits: [
      {
        ...
        description:
          'You could not break the viewing conversation in front of you to answer a fresh call or viewing request. By the time you stepped outside and listened back, another agent had already got the first proper conversation.',
      ...
      },
      {
        ...
        description:
          'A portal lead comes through, and the same lead likely goes through to two or three other agents nearby. The one who rings inside ten minutes usually becomes the name they remember when the instruction gets serious later that day.',
      ...
      },
      {
        ...
        description:
          'A buyer who said "we are probably looking again in spring" never heard from you in spring. A vendor who wanted to wait until summer never got the second call. The deal did not vanish overnight. It just moved to the person who replied again.',
  ...
  const workflowExamplesData = {
    ...
    description:
      'These are the small handoffs between portal, phone, and follow-up that decide who stays in the frame. When they fail, the instruction often slips before anybody even says they have moved on.',
    workflows: [
      {
  ...
  const systemLayersData = {
    ...
    description:
      'You stay at viewings, valuations, and negotiations. The minutes that decide each enquiry, plus the later follow-up that keeps it alive, stop depending on you being perfectly free at exactly the right second.',
    featureCategories: [
      {
        title: 'Catch the enquiry in the first minute',
        description:
          'Portal forms, website forms, viewing requests, and missed calls all get a reply that feels personal within a minute. That keeps the lead warm until you can give it proper attention.',
        icon: MessageSquare,
        features: [
      ...
      },
      {
        ...
        description:
          "Old buyers, old vendors, and old valuations stay visible instead of dropping into an old spreadsheet or somebody's memory. Nudges go out on a sensible cycle so the next decision does not happen without you.",
        icon: Clock,
        features: [
      ...
      },
      {
        ...
        description:
          'A booked-in callback time works better than "I will ring you back later" because it gives the buyer or seller something concrete to wait for. That cuts down the drift that happens when they hear nothing and call the next agent instead.',
        icon: KeyRound,
        features: [
      ...
      },
      {
        ...
        description:
          'A review request goes out after exchange or completion, when the relief is still fresh and the work is easy to describe. That helps the online proof catch up to the amount of business you are already getting through.',
        icon: ShieldCheck,
        features: [
      ...
      },
      {
        ...
        description:
          'Your pages and Google profile line up around the postcodes, property types, and buyer or seller intent you actually want more of. That makes it easier to be visible when the instruction is still being decided.',
        icon: Search,
        features: [
  ...
  const exploreData = {
    badge: 'Related',
    description:
      'These are the supporting services that come up most often once an agency sees how much is being lost in speed and follow-up. They reinforce first response, memory, proof, and local visibility from different angles.',
    cards: [
      {
        icon: MessageSquare,
        title: 'Smart Website Systems',
        description:
          'Helps you be the first response even when you are mid-viewing, on a valuation, or away from the desk when the lead lands.',
      ...
      },
      {
        ...
        description:
          'Keeps old buyers and vendors visible so the next useful follow-up comes from you, not the agent who simply remembered them first.',
      ...
      },
      {
        ...
        description:
          'Gets reviews out after completed sales so the next vendor sees proof that feels current, local, and grounded in real outcomes.',
      ...
      },
      {
        ...
        description:
          'Helps you read as the trusted agent for the area itself, not just one more listing on the portal with the same stock language.',
  ...
  const faqData = {
    ...
    description:
      'These are the practical questions that usually come up in a phone-driven, viewing-led week where speed matters early and follow-up matters later. Straight answers, no padding.',
    faqs: [
      {
