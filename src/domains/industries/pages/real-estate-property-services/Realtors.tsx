...
export const realtorsIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Realtors Systems',
      description: 'Enquiry handling, follow-up, and trust structure for realtors.',
    },
  },
  slug: 'realtors',
  type: 'detail',
  ...
  hero: {
    badge: 'Realtors',
    title: 'Realtors [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Realtors leak pattern',
      description:
        'Show the exact points where realtors lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about realtors systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where realtors enquiries slip',
      description:
