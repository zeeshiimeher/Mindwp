...
export const homeInspectorsIndustryPageData: IndustryDetailPageData = {
  seo: {
    title: 'Home Inspectors Systems',
    description:
      'Holding structure for home inspectors: enquiry capture, fast response, follow-up ownership, and local trust.',
    canonical: '/industries/real-estate-property-services/home-inspectors',
    openGraph: {
      title: 'Home Inspectors Systems',
      description: 'Enquiry handling, follow-up, and trust structure for home inspectors.',
    },
  },
  ...
  hero: {
    badge: 'Home Inspectors',
    title: 'Home Inspectors [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Home Inspectors leak pattern',
      description:
        'Show the exact points where home inspectors lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about home inspectors systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where home inspectors enquiries slip',
      description:
