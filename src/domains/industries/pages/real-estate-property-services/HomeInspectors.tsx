...
function buildHomeInspectorsIndustryPageData(): IndustryPageData {
  const heroData = {
    ...
    title:
      'The Agent Needed Someone Booked For Thursday. You Replied Friday Morning. Thursday Was Already Inspected.',
    description:
    ...
    benefits: [
      {
        ...
        description:
          'They needed the inspection booked before the end of the week so the deal could keep moving. By the time you came back with availability, the agent had already used someone else who replied the same morning and gave them a clear slot.',
      ...
      },
      {
        ...
        description:
          'You could not pick up because you were on site and could not safely stop. They kept working down their list because they needed an answer now, and by the time you came down at 3pm the booking had already gone.',
      ...
      },
      {
        ...
        description:
          'They were already coordinating the buyer, lender, and vendor and needed to know where things stood. Silence from you after the report made the whole process feel harder than it needed to be, and that is when repeat referrals start slipping away.',
  ...
  const workflowExamplesData = {
    ...
    description:
      "These are the small coordination steps between agent, buyer, and inspector that decide whether you stay in the agent's rotation. When they are handled well, a one-off booking is much more likely to turn into repeat work.",
    workflows: [
      {
  ...
  const systemLayersData = {
    ...
    description:
      'You stay focused on doing the inspection properly. The booking window, the on-site missed call, and the follow-up that keeps the agent informed stop depending on you being near the phone at exactly the right moment.',
    featureCategories: [
      {
        title: 'Confirm availability inside the hour',
        description:
          'Agent enquiries get specific slot offers instead of "let me get back to you" because that delay is usually where the booking disappears. A clear slot inside the hour helps hold the job before they move down their list.',
        icon: CalendarRange,
        features: [
      ...
      },
      {
        ...
        description:
          'Missed calls during an inspection get a short, named auto-reply with a callback time, so the agent knows they have actually reached someone. The lead does not go cold just because you were on site when it came in.',
        icon: PhoneCall,
        features: [
      ...
      },
      {
        ...
        description:
          'Status updates go out automatically when the booking, inspection, and report each move forward. That helps the agent coordinate the buyer and the rest of the chain without having to keep chasing you for basic visibility.',
        icon: ClipboardCheck,
        features: [
      ...
      },
      {
        ...
        description:
          'A review request goes out after the report lands, when the buyer or agent is most relieved that the deadline has been met and the report is in hand. That makes the review ask feel more natural and timely.',
        icon: ShieldCheck,
        features: [
      ...
      },
      {
        ...
        description:
          'Your pages and Google profile line up around postcode and inspection type so urgent agents and buyers find you quickly for the exact work you cover. That reduces time lost on generic enquiries and makes the right bookings easier to win.',
        icon: Search,
        features: [
  ...
  const exploreData = {
    badge: 'Related',
    description:
      'These are the supporting services that come up most often once an inspector sees how much hinges on calendar speed and clean coordination. They reinforce booking response, visibility, proof, and follow-up from different sides.',
    cards: [
      {
        icon: HardHat,
        title: 'Smart Website Systems',
        description:
          'Helps you confirm availability the same hour, even when you are on site and cannot stop to manage the booking manually.',
      ...
      },
      {
        ...
        description:
          'Keeps agents and buyers in the loop without extra calls so the whole chain has clearer visibility around the booking and report.',
      ...
      },
      {
        ...
        description:
          'Gets reviews from delivered reports in the places referring agents and future buyers actually check when choosing who to trust.',
      ...
      },
      {
        ...
        description:
          'Helps you show up as the inspector for the area and job type, not just another name on a list when time is already tight.',
  ...
  const faqData = {
    ...
    description:
      'These are the practical questions that usually come up in a calendar-driven, on-site week where deadlines are tight and coordination matters. Straight answers based on that reality.',
    faqs: [
      {
  ...
  return {
    seo: {
      title: 'Home Inspectors — Win The Booking Window, Keep The Referring Agent',
      description:
