...
export const mortgageBrokersIndustryPageData: IndustryDetailPageData = {
  seo: {
    title: 'Mortgage Brokers Systems',
    description:
      'Holding structure for mortgage brokers: enquiry capture, fast response, follow-up ownership, and local trust.',
    canonical: '/industries/real-estate-property-services/mortgage-brokers',
    openGraph: {
      title: 'Mortgage Brokers Systems',
      description: 'Enquiry handling, follow-up, and trust structure for mortgage brokers.',
    },
  },
  ...
  hero: {
    badge: 'Mortgage Brokers',
    title: 'Mortgage Brokers [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Mortgage Brokers leak pattern',
      description:
        'Show the exact points where mortgage brokers lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about mortgage brokers systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where mortgage brokers enquiries slip',
      description:
