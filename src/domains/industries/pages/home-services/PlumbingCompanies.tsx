...
export const plumbingCompaniesIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Plumbing Companies Systems',
      description: 'Enquiry handling, follow-up, and trust structure for plumbing companies.',
    },
  },
  ...
  hero: {
    badge: 'Plumbing Companies',
    title: 'Plumbing Companies [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Plumbing Companies leak pattern',
      description:
        'Show the exact points where plumbing companies lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about plumbing companies systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where plumbing companies enquiries slip',
      description:
