...
export const landscapingCompaniesIndustryPageData: IndustryDetailPageData = {
  seo: {
    title: 'Landscaping Companies Systems',
    description:
      'Holding structure for landscaping companies: enquiry capture, fast response, follow-up ownership, and local trust.',
    canonical: '/industries/home-services/landscaping-companies',
    openGraph: {
      title: 'Landscaping Companies Systems',
      description: 'Enquiry handling, follow-up, and trust structure for landscaping companies.',
    },
  },
  ...
  hero: {
    badge: 'Landscaping Companies',
    title: 'Landscaping Companies [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Landscaping Companies leak pattern',
      description:
        'Show the exact points where landscaping companies lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about landscaping companies systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where landscaping companies enquiries slip',
      description:
