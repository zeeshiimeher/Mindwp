...
export const roofingCompaniesIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Roofing Companies Systems',
      description: 'Enquiry handling, follow-up, and trust structure for roofing companies.',
    },
  },
  ...
  hero: {
    badge: 'Roofing Companies',
    title: 'Roofing Companies [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Roofing Companies leak pattern',
      description:
        'Show the exact points where roofing companies lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about roofing companies systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where roofing companies enquiries slip',
      description:
