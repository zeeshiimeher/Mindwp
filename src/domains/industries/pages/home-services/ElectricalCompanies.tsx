...
export const electricalCompaniesIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Electrical Companies Systems',
      description: 'Enquiry handling, follow-up, and trust structure for electrical companies.',
    },
  },
  ...
  hero: {
    badge: 'Electrical Companies',
    title: 'Electrical Companies [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Electrical Companies leak pattern',
      description:
        'Show the exact points where electrical companies lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about electrical companies systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where electrical companies enquiries slip',
      description:
