...
export const hvacCompaniesIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'HVAC Companies Systems',
      description: 'Enquiry handling, follow-up, and trust structure for HVAC companies.',
    },
  },
  slug: 'hvac-companies',
  type: 'detail',
  ...
  hero: {
    badge: 'HVAC Companies',
    title: 'HVAC Companies [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'HVAC Companies leak pattern',
      description:
        'Show the exact points where HVAC companies lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about hvac companies systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where hvac companies enquiries slip',
      description:
