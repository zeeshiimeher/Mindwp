    ...
    benefits: [
      {
        ...
        description:
          'Someone turns up mid-job asking if you can look at it today, while another person is still waiting to confirm a drop-off time. The diary and the bench start fighting each other because nothing feels properly scheduled.',
      ...
      },
      {
        ...
        description:
          'You fixed it, they paid, and the experience was fine. Six months later, when the next small problem shows up, they Google again because nobody reminded them they already had a shop they trusted.',
      ...
      },
      {
        ...
        description:
          'Quick fixes often feel too small for the admin, so they get pushed to later and then forgotten completely. That is exactly the kind of job that makes someone decide your shop feels hard to pin down next time.',
      ...
      },
      {
        ...
        description:
          'Plenty of happy people leave the counter with the repair sorted and almost no proof of it appears online afterwards. The next person searching locally only sees whichever shop remembered to ask.',
        iconType: 'primary' as const,
      },
    ],
    columns: 4 as const,
    ...
    featureCategories: [
      {
        ...
        description:
          'A clearer way to take drop-offs without letting the bench get derailed by whoever happened to walk in next. That helps the day feel more organised for you and more predictable for the person booking.',
        icon: Calendar,
        features: [
      ...
      },
      {
        ...
        description:
          'Quiet recall messages go out on a sensible cycle so the people you already helped think of you first next time. That matters more than most shops realise because a lot of repeat work is lost through simple forgetfulness.',
        icon: RotateCcw,
        features: [
      ...
      },
      {
        ...
        description:
          'A shorter reply path keeps quick fixes from getting dropped just because they felt too small to deal with right away. That helps the easier jobs get booked in without turning into a trail of half-finished admin.',
        icon: ClipboardList,
        features: [
      ...
      },
      {
        ...
        description:
          'A review ask goes out after collection, when the person has the item back and the fix still feels fresh. That is the point where they are most likely to leave something useful instead of forgetting once they get home.',
        icon: ShieldCheck,
        features: [
      ...
      },
      {
        ...
        description:
          'Your pages and Google profile line up around the kinds of repairs you actually want more of. That helps more local people checking timing and convenience find you before they just default to the nearest name they recognise.',
        icon: Search,
        features: [
    ...
    cards: [
      {
        ...
        description:
          'Keeps past jobs warm and stops smaller repairs from disappearing just because nobody got back to them clearly enough.',
      ...
      },
      {
        ...
        description:
          'Helps enquiries, walk-ins, and bookings stay in one place so timing and drop-off handling feel clearer from the first contact.',
      ...
      },
      {
        ...
        description:
          'Helps you show up when local people search for the repair you actually do and want booked in, not just generic repair terms.',
      ...
      },
      {
        ...
        description:
          'Turns finished repairs into proof on Google, so the next person checking who feels trustworthy sees more than just a star count.',
