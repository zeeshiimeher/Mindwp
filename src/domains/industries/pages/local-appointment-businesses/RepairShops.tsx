...
export const repairShopsIndustryPageData: IndustryDetailPageData = {
  seo: {
    title: 'Repair Shops Systems',
    description:
      'Holding structure for repair shops: enquiry capture, fast response, follow-up ownership, and local trust.',
    canonical: '/industries/local-appointment-businesses/repair-shops',
    openGraph: {
      title: 'Repair Shops Systems',
      description: 'Enquiry handling, follow-up, and trust structure for repair shops.',
    },
  },
  slug: 'repair-shops',
  type: 'detail',
  ...
  hero: {
    badge: 'Repair Shops',
    title: 'Repair Shops [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Repair Shops leak pattern',
      description:
        'Show the exact points where repair shops lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about repair shops systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where repair shops enquiries slip',
      description:
