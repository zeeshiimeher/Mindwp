    ...
    benefits: [
      {
        ...
        description:
          'A single email six months later is easy to ignore, especially for the people who already do not love coming in. One reminder without any follow-up is rarely enough to turn intention into an actual booking.',
      ...
      },
      {
        ...
        description:
          'They said yes in the chair, then life got busy, the cost needed thinking about, or they wanted to wait until after a holiday. Nobody followed up gently while the decision was still sitting there unfinished.',
      ...
      },
      {
        ...
        description:
          'The people you most need to see are often the ones most likely to delay, especially if there is anxiety or discomfort involved. Cold reminders or slow booking replies usually push them further away instead of bringing them closer.',
    ...
    featureCategories: [
      {
        ...
        description:
          'Recall messages stay short, warm, and written like a real person instead of a generic reminder feed. Then a gentle second nudge goes out if needed, because one message alone rarely catches the people who keep postponing.',
        icon: Bell,
        features: [
      ...
      },
      {
        ...
        description:
          'A polite check-in goes out at sensible intervals so agreed work does not simply disappear after the chair conversation. That matters most when the patient intended to book but needed more time and then went quiet.',
        icon: ClipboardList,
        features: [
      ...
      },
      {
        ...
        description:
          'A first reply reassures, captures the reason for the enquiry, and makes the next step clear quickly enough for both pain cases and routine patients. That helps pain callers feel answered and routine enquiries feel easy to book without a long delay.',
        icon: MessageSquare,
        features: [
      ...
      },
      {
        ...
        description:
          'A steady flow of recent reviews helps Google look the way the clinic actually feels when someone visits or calls. That matters for both the person in pain checking quickly and the routine patient taking longer to decide.',
        icon: ShieldCheck,
        features: [
      ...
      },
      {
        ...
        description:
          'Your pages and Google profile line up around treatment and area instead of generic dentistry alone. That makes it easier to show up for both urgent pain searches and slower treatment research without blurring the two together.',
        icon: Search,
        features: [
    ...
    cards: [
      {
        ...
        description:
          'Keeps two-touch recall and treatment follow-up moving so the chair is not left relying on one reminder and crossed fingers.',
      ...
      },
      {
        ...
        description:
          'Helps pages and first replies read warm and clear, so pain enquiries and routine questions both feel handled properly from the start.',
      ...
      },
      {
        ...
        description:
          'Builds a steady flow of recent reviews that patients actually read while deciding whether this clinic feels trustworthy enough to book.',
      ...
      },
      {
        ...
        description:
          'Helps you show up for treatment and area searches with clearer intent, whether someone is looking for urgent help or planning a routine visit.',
