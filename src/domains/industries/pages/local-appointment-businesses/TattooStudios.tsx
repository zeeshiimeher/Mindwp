    ...
    benefits: [
      {
        ...
        description:
          'Your work lives in their saved folder beside three other artists they are considering. The DM never gets typed because the timing slips or another profile feels easier to message when they come back to it later.',
      ...
      },
      {
        ...
        description:
          'They are sitting with it, checking other artists, and deciding whether the style really feels like the right fit. If the reply was slow or the conversation felt thin, you stop being the studio they keep coming back to in their head.',
      ...
      },
      {
        ...
        description:
          'The conversation can feel warm right up until the deposit ask lands too abruptly or too vaguely. When that happens, the booking often goes quiet rather than turning into an actual no.',
    ...
    featureCategories: [
      {
        ...
        description:
          'A reference photo, a vague description, and a half-formed idea all stay held together in one place per artist. That makes it easier to reply in a way that feels specific enough to keep the conversation alive.',
        icon: MessageSquare,
        features: [
      ...
      },
      {
        ...
        description:
          'How and when the deposit is asked often decides whether the conversation survives it. A clearer, friendlier ask tied to a real next step usually lands better than dropping a cold payment link into the chat.',
        icon: HandCoins,
        features: [
      ...
      },
      {
        ...
        description:
          'A couple of soft nudges go out over the weeks they are thinking it through, comparing artists, or waiting for the right timing. That helps the studio stay in the frame without turning the whole thing into a hard sell.',
        icon: Heart,
        features: [
      ...
      },
      {
        ...
        description:
          'Healed photos, review asks, and a quiet door for the next piece all happen while the work still feels current and worth sharing. That makes it easier for one good experience to turn into the next booking or referral.',
        icon: ShieldCheck,
        features: [
      ...
      },
      {
        ...
        description:
          'Your pages and Google profile line up around style and area, so the person who saved a reference three months ago can actually find you again when they are finally ready to book. That matters more than most studios realise.',
        icon: Search,
        features: [
    ...
    cards: [
      {
        ...
        description:
          'Helps style-led pages and artist profiles hold attention long enough for the right person to feel the match and send the next message.',
      ...
      },
      {
        ...
        description:
          'Keeps the studio in their head while they think, compare artists, and decide whether to book, without anyone having to chase manually.',
      ...
      },
      {
        ...
        description:
          'Uses healed photos and reviews to pull the next booking in, especially from people still deciding which artist feels safest to trust.',
      ...
      },
      {
        ...
        description:
          'Ties the deposit to a specific session and next step so it does not kill the chat right when the person was almost ready to commit.',
        href: '/services/crm-infrastructure-implementation',
        gradient: 'blue',
        iconBg: 'blue',
      },
  ...
  const faqData = {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Yes. Enquiries land with the right artist, with the reference and notes attached.',
      },
      {
