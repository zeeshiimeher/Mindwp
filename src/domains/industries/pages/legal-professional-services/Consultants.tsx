...
export const consultantsIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Consultants Systems',
      description: 'Enquiry handling, follow-up, and trust structure for consultants.',
    },
  },
  slug: 'consultants',
  type: 'detail',
  ...
  hero: {
    badge: 'Consultants',
    title: 'Consultants [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Consultants leak pattern',
      description:
        'Show the exact points where consultants lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about consultants systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where consultants enquiries slip',
      description:
