    ...
    steps: [
      {
        ...
        description:
          'Where they came from, who replied, who never replied, and what happened next.',
      },
      {
        number: '02',
        title: 'Map the silent drop-offs',
        description:
          'Half-typed forms, unsent proposals, quiet quotes. The leak that nobody has been measuring.',
      },
      {
        number: '03',
        title: 'Fix the biggest leak first',
        description:
          'Acknowledgement, follow-up, offer clarity, or proof — whichever is costing the practice the most work right now.',
      },
      {
        number: '04',
        title: 'Let it run while the partners do the work',
        description:
          'Replies, reminders, reviews, follow-up. Quietly going in the background while fee earners do the actual practice.',
      },
    ],
    columns: 4 as const,
    backgroundColor: 'bg-base',
    ...
    cards: [
      {
        ...
        description:
          'Keeps open proposals and slower decisions visible so nobody has to rely on memory to send the next follow-up.',
      ...
      },
      {
        ...
        description:
          'Helps new enquiries get a prompt, grounded first reply so the prospect does not sit there wondering what happens next.',
      ...
      },
      {
        ...
        description:
          'Makes the visible proof feel closer to the standard of work the firm is already delivering behind the scenes.',
      ...
      },
      {
        ...
        description:
          'Helps the firm show up for the kind of brief, niche, or local search that is actually worth taking seriously.',
