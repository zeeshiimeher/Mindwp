...
function buildSmallLawFirmsIndustryPageData(): IndustryPageData {
    ...
    benefits: [
      {
        ...
        description:
          'Halfway through, they realised they were not ready to put the situation in writing to a stranger just yet. They closed the tab, told themselves they would come back tomorrow, and often did not.',
      ...
      },
      {
        ...
        description:
          'Anonymous contact pages rarely do enough when the issue feels personal or high-stakes. A name, a face, and a tone that feels steady can be what finally makes someone decide to get in touch.',
      ...
      },
      {
        ...
        description:
          "A cold or delayed first response can confirm the prospect's worry that the whole process will feel difficult or impersonal. They do not usually argue with that feeling. They just do not proceed.",
  ...
  const systemLayersData = {
    ...
    title:
      'Lower the barrier to the first conversation, then handle it like a professional firm should',
    description:
    ...
    featureCategories: [
      {
        ...
        description:
          'The first step stays short and low-pressure instead of asking for a full case summary upfront. That matters when the person is still deciding whether they are ready to explain the issue to anybody at all.',
        icon: FileSignature,
        features: [
      ...
      },
      {
        ...
        description:
          'The first response sounds like a real person at the firm rather than a cold portal acknowledgement. It stays calm, clear, and dated so the prospect knows exactly what happens next and when.',
        icon: MessageSquare,
        features: [
      ...
      },
      {
        ...
        description:
          'Started-but-abandoned forms and missed calls stay visible in one place instead of disappearing without trace. One polite, carefully judged follow-up gives the person a second chance to continue when the moment feels easier.',
        icon: ShieldCheck,
        features: [
      ...
      },
      {
        ...
        description:
          'A short consultation slot can be picked without the usual back-and-forth that makes people put it off again. Reminders help the appointment still happen once they have finally built up to booking it.',
        icon: Calendar,
        features: [
      ...
      },
      {
        ...
        description:
          'Your pages and Google profile line up around the matter types and areas you actually want to handle. That helps someone recognise the fit quickly when they finally decide they are ready to contact a firm.',
        icon: Search,
        features: [
    ...
    cards: [
      {
        ...
        description:
          'Helps pages and first replies lower the barrier to the first call so a worried prospect does not back out before the firm even hears from them.',
      ...
      },
      {
        ...
        description:
          'Builds the trust signals worried people quietly check before they decide whether this firm feels safe enough to contact.',
      ...
      },
      {
        ...
        description:
          'Keeps half-typed enquiries and missed calls from disappearing completely, while handling follow-up with the right level of care.',
      ...
      },
      {
        ...
        description:
          'Helps the firm show up for the right matter type and area instead of blending into broad, generic legal search results.',
