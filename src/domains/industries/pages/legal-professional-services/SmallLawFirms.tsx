...
export const smallLawFirmsIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Small Law Firms Systems',
      description: 'Enquiry handling, follow-up, and trust structure for small law firms.',
    },
  },
  ...
  hero: {
    badge: 'Small Law Firms',
    title: 'Small Law Firms [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Small Law Firms leak pattern',
      description:
        'Show the exact points where small law firms lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about small law firms systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where small law firms enquiries slip',
      description:
