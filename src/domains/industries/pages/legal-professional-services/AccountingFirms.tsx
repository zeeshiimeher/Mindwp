        ...
        featureCategories: [
            {
                ...
                description: 'No more "did anyone follow up with that property developer?" or "who last spoke to that retailer?" Every open proposal stays visible so it does not depend on one partner remembering it existed.',
                icon: ClipboardCheck,
                features: [
            ...
            },
            {
                ...
                description: 'Two short, friendly check-ins go out across a couple of weeks and sound like a sensible professional follow-up, not a sales chase. The moment they reply or decide, the follow-up stops.',
                icon: Bell,
                features: [
            ...
            },
            {
                ...
                description: 'A same-hour acknowledgement helps hold the enquiry before the owner keeps contacting other firms for the same work. That matters most when they are still deciding who feels most responsive before a proposal is even discussed.',
                icon: MessageCircle,
                features: [
            ...
            },
            {
                ...
                description: 'A review request goes out after the first quarter, when the relief of switching accountants is still fresh and the business owner can still describe why they moved. That makes the proof feel more grounded and current.',
                icon: ShieldCheck,
                features: [
            ...
            },
            {
                ...
                description: 'Your pages and Google profile line up around niche, sector, and area instead of generic accountancy language. That makes it easier for the right prospect to recognise the fit before they start comparing firms in earnest.',
                icon: Search,
                features: [
        ...
        cards: [
            {
                ...
                description: 'Keeps open proposals visible, sends the next nudge at the right time, and stops good prospects from quietly fading out after the quote lands.',
            ...
            },
            {
                ...
                description: 'Helps enquiries get acknowledged quickly so prospects do not keep emailing other firms while waiting to see who replies first.',
            ...
            },
            {
                ...
                description: 'Builds the review base the firm has already earned so trust shows up before the proposal stage, not just after a prospect asks around.',
            ...
            },
            {
                ...
                description: 'Helps the firm show up for the niche, sector, and type of business owner it actually wants more of, not just broad accountancy searches.',
