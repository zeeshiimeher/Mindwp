...
export const carDetailingIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Car Detailing Systems',
      description: 'Enquiry handling, follow-up, and trust structure for car detailing businesses.',
    },
  },
  slug: 'car-detailing',
  type: 'detail',
  ...
  hero: {
    badge: 'Car Detailing',
    title: 'Car Detailing [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Car Detailing leak pattern',
      description:
        'Show the exact points where car detailing businesses lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about car detailing systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where car detailing enquiries slip',
      description:
