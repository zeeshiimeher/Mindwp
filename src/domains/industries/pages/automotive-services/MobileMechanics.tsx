...
export const mobileMechanicsIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Mobile Mechanics Systems',
      description: 'Enquiry handling, follow-up, and trust structure for mobile mechanics.',
    },
  },
  ...
  hero: {
    ...
    title: 'Mobile Mechanics [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Mobile Mechanics leak pattern',
      description:
        'Show the exact points where mobile mechanics lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about mobile mechanics systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where mobile mechanics enquiries slip',
      description:
