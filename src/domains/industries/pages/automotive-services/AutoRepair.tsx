...
export const autoRepairIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Auto Repair Systems',
      description: 'Enquiry handling, follow-up, and trust structure for auto repair shops.',
    },
  },
  slug: 'auto-repair',
  type: 'detail',
  ...
  hero: {
    badge: 'Auto Repair',
    title: 'Auto Repair [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Auto Repair leak pattern',
      description:
        'Show the exact points where auto repair shops lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about auto repair systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where auto repair enquiries slip',
      description:
