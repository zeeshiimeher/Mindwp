...
export const bodyShopsIndustryPageData: IndustryDetailPageData = {
  seo: {
    ...
    openGraph: {
      title: 'Body Shops Systems',
      description: 'Enquiry handling, follow-up, and trust structure for body shops.',
    },
  },
  slug: 'body-shops',
  type: 'detail',
  ...
  hero: {
    badge: 'Body Shops',
    title: 'Body Shops [[muted:systems that keep enquiries moving]]',
    description:
  ...
  industryPattern: {
    header: {
      kicker: 'Leak Pattern',
      title: 'Body Shops leak pattern',
      description:
        'Show the exact points where body shops lose enquiries, bookings, quotes, or trust.',
    },
  ...
  faq: {
    header: {
      kicker: 'FAQ',
      title: 'Questions about body shops systems',
      description:
  ...
  cta: {
    heading: {
      kicker: 'Next Step',
      title: 'Show us where body shops enquiries slip',
      description:
