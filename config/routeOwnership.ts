...
export function resolveRouteOwnership(path: string, kind: IndexingPolicyKind): RouteOwnershipRule | null {
...
export function assertRouteOwnershipEntries(entries: Array<{ path: string; kind: IndexingPolicyKind }>) {
